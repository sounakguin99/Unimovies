...
export default function SidebarFilters({ genres, onApplyFilters }: SidebarFiltersProps) {
  ...
  // Accordion open/close states (like TMDB)
        ...
        {filtersOpen && (
          <div className="border-t border-gray-100">
            ...
            <div className="p-4 border-b border-gray-100">
              <h3 className="font-medium text-gray-700 mb-3">Release Dates</h3>
              ...
              <div className="flex flex-wrap gap-2">
                {genres.map(g => (
                  <button
                    ...
                    className={`px-3 py-1 text-xs border rounded-full transition-colors ${withGenres.includes(g.id)
